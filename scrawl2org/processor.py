...
class PDFProcessor:
    ...
    def _process_page(self, doc: fitz.Document, page_num: int, pdf_file_id: int, force_update: bool):
        ...
        # Store the image
        self.db.store_page_image(pdf_file_id, page_num, image_data)
        print(f"  Page {page_num + 1}: stored ({len(image_data)} bytes)")
