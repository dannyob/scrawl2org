...
class KittyImageDisplay:
    ...
    @staticmethod
    def display_image(image_data: bytes, filename: Optional[str] = None, width: Optional[int] = None, height: Optional[int] = None) -> None:
    ...
    @staticmethod
    def display_image_sized(image_data: bytes, width: int, height: int, filename: Optional[str] = None) -> None:
